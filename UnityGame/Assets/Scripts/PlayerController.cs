...
public class PlayerController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        {
            if(!isDialogueActive && !Final.IsFinalGame())
    ...
    void Jump()
    {
        if (isGrounded == true && Input.GetKeyDown(KeyCode.Space) && !isDialogueActive && !Final.IsFinalGame())
        {
    ...
    public bool onFireLadder = false;
